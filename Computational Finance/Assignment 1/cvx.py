# -*- coding: utf-8 -*-
"""
Created on Tue Feb 26 17:33:29 2019
...
plt.scatter(sim_frame.stdev,sim_frame.ret)
plt.xticks(fontsize=16)
plt.yticks(fontsize=16)
plt.ylabel('Mean Return',fontsize=20)
plt.xlabel('Volatility',fontsize=20)
plt.xlim(0.005,.016)
plt.ylim(-0.004,0.0005)
plt.title("Efficient Frontier for Minimum Variance and Maximum Return",fontsize=18,y=+1.15)

#Plot a red star to highlight position of the portfolio with highest Sharpe Ratio
plt.scatter(max_sharpe[1],max_sharpe[0],color='r',s=100)

#Plot a blue star to highlight position of the portfolio with minimum Variance
plt.scatter(min_std[1],min_std[0],color='yellow',s=100)
plt.show()
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 16 17:49:04 2019
...
plt.title("Daily Returns - 1/N Portfolio")
...
r=daily_simple_returns.iloc[:, 0:numstocks].mul(portfolio_weights_ew, axis=1).sum(axis=1)
CumulativeReturns = ((1+r).cumprod()-1)
CumulativeReturns.plot()
plt.xticks(rotation=90)
plt.title("Cumulative Portfolio Return over time")
CumulativeReturns = ((1+re).cumprod()-1)
